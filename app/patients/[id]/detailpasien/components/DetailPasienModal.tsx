...
const DetailPasienModal: React.FC<Props> = ({
  isOpen,
  onClose,
  systemTime,
  form,
      ...
      <div className="relative w-full max-w-4xl rounded-2xl border border-slate-200 bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-slate-200 px-5 py-4">
          <div className="flex flex-col gap-1">
            {submitError && (
              <div className="text-[13px] text-rose-600">{submitError}</div>
            )}
            {submitSuccess && (
            ...
            <div className="text-[11px] text-slate-500">
              * Field dengan tanda * wajib diisi. Sistem akan menambahkan entri
              baru ke tabel rekap per jam.
            </div>
          </div>
