// app/patients/[id]/perkembanganpasien/components/CatatanTerintegrasiHeader.tsx
...
const CatatanTerintegrasiHeader: React.FC<CatatanTerintegrasiHeaderProps> = ({
  noRm,
  tanggal,
  hariPerawatanKe,
}) => {
      ...
      <div className="relative flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative space-y-2">
          ...
          <p className="max-w-xl text-xs text-emerald-100/90">
            ...
            instruksi PPA dan paraf perawat.
          </p>
        </div>
