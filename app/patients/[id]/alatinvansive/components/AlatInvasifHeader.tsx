// app/patients/[id]/alatinvansive/components/AlatInvasifHeader.tsx
...
interface AlatInvasifHeaderProps {
  noRm?: string;
  tanggal?: string;
  hariPerawatanKe?: number;
}

const AlatInvasifHeader: React.FC<AlatInvasifHeaderProps> = ({
  noRm,
  tanggal,
  hariPerawatanKe,
}) => {
      ...
      <div className="relative flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative space-y-2">
          ...
          <p className="max-w-xl text-xs text-emerald-100/90">
            ...
            dan rekap balance cairan 24 jam dalam satu tampilan.
          </p>
        </div>
...
export default AlatInvasifHeader;
